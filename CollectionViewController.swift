...
class CollectionViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override func viewWillAppear(_ animated: Bool) {
        self.myDynamicTableView.reloadData()
    }
    ...
    override func viewDidLoad() {
        ...
        myDynamicTableView.register(myTableViewCellNib, forCellReuseIdentifier: "myTableViewCell")
...
//        if let txt = addTextLabel.text, !txt.isEmpty {
//        secondViewController.result.insert(txt, at: 0)
//        secondViewController.myDynamicTableView?.beginUpdates()
//        secondViewController.myDynamicTableView?.insertRows(at: [IndexPath(row: 0, section: 0)], with: .right)
//        secondViewController.myDynamicTableView?.endUpdates()
        }
